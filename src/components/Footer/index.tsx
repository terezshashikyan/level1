            ...
            <div className="footerNavbar container">
                <div className='footerNavbar__links'>
                  <div className="footerNavbar__socialMediaLinks">
                    <a className ='footerNavbar__SocialMediaLink' href="#Instagram"><img src= {Instagram}  alt="Instagram"/></a>
                    <a className ='footerNavbar__SocialMediaLink' href="#Facebook"><img src= {Facebook} alt="Facebook"/></a>
                    <a className ='footerNavbar__SocialMediaLink' href="#Linkedin"><img src= {Linkedin} alt="Linkedin"/></a>
                </div>
